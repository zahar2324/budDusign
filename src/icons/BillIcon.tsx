const BillIcon = () => {
  return (
    <svg width="85px" height="85px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M10.5 11L17 11" stroke="#c5a47e" stroke-width="1.5" stroke-linecap="round" />
      <path d="M7 11H7.5" stroke="#c5a47e" stroke-width="1.5" stroke-linecap="round" />
      <path d="M7 7.5H7.5" stroke="#c5a47e" stroke-width="1.5" stroke-linecap="round" />
      <path d="M7 14.5H7.5" stroke="#c5a47e" stroke-width="1.5" stroke-linecap="round" />
      <path d="M17 14.5H16M10.5 14.5H13.5" stroke="#c5a47e" stroke-width="1.5" stroke-linecap="round" />
      <path d="M17 7.5H14M10.5 7.5H11.5" stroke="#c5a47e" stroke-width="1.5" stroke-linecap="round" />
      <path
